...
// Barrier Spell
val barrier_spell = VanillaFactory.createItem("barrier_spell");
barrier_spell.itemRightClick = function(stack, world, player, hand) {
    Commands.call("tell @p PLACEHOLDER", player, world);
    return "Pass";
};
barrier_spell.register();
...
val wardingRune = VanillaFactory.createItem("warding_rune");
wardingRune.setCreativeTab(<creativetab:Dunamis>);
wardingRune.maxDamage = 8;
wardingRune.maxStackSize = 1;
wardingRune.register();
...
// val wardingOrb = VanillaFactory.createItem("warding_orb");
// wardingOrb.setCreativeTab(<creativetab:Dunamis>);
// wardingOrb.register();
...
val wardingQ = VanillaFactory.createItem("warding_quintessence");
wardingQ.setCreativeTab(<creativetab:Dunamis>);
wardingQ.register();
